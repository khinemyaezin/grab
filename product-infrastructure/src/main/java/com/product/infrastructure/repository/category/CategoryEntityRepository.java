...
@Repository
public interface CategoryEntityRepository extends EntityRepository<CategoryEntity, Long>, JpaRepository<CategoryEntity, Long>, CriteriaNodeRepository<CategoryEntity, Long> {
}
