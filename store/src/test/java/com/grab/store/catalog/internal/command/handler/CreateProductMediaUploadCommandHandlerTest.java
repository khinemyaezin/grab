...
class CreateProductMediaUploadCommandHandlerTest {

    private ProductRepository productRepository;
    private FileStoragePort fileStoragePort;
    private CreateProductMediaUploadCommandHandler handler;
    ...
    void setUp() {
        ...
        handler = new CreateProductMediaUploadCommandHandler(
                productRepository,
                fileStoragePort,
                idGenerator,
    ...
    void issuesPresignedPutWithProductScopedKey() {
        ...
        ProductMediaUploadResult result = handler.handle(new CreateProductMediaUploadCommand(
                new CommonId("merchant-1"),
                new CommonId("product-1"),
                "hero.jpg",
                "image/jpeg",
    ...
    void rejectsDisallowedContentType() {
        ...
        assertThatThrownBy(() -> handler.handle(new CreateProductMediaUploadCommand(
                new CommonId("merchant-1"),
                new CommonId("product-1"),
                "notes.txt",
                "text/plain",
