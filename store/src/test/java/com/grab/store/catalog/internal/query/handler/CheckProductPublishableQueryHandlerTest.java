...
class CheckProductPublishableQueryHandlerTest {

    @Mock
    private ProductRepository productRepository;

    private CheckProductPublishableQueryHandler handler;

    @BeforeEach
    void setUp() {
        handler = new CheckProductPublishableQueryHandler(productRepository, ids());
    }
    ...
    void handle_whenOwnedAndActive_isPublishable() {
        ...
        CheckProductPublishableResult result = handler.handle(
