...
public class InventoryLineValidator
        implements ConstraintValidator<ValidInventoryLine, UpdateProductVariantRequest.InventoryLine> {

    @Override
    public boolean isValid(UpdateProductVariantRequest.InventoryLine line, ConstraintValidatorContext context) {
