...
public class ActivateBinService implements ActivateBinUseCase {

    private static final Logger log = Loggers.getLogger(ActivateBinService.class);
    ...
    private final InventoryLocationAccessPolicy locationAccessPolicy;
            ...
            public BinResult execute(ActivateBinCommand command) {
