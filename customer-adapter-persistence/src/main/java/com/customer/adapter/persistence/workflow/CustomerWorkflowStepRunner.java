package com.customer.adapter.persistence.workflow;
...
public class CustomerWorkflowStepRunner extends WorkflowStepRunner {
    private final TransactionTemplate stepTransaction;
    private final TransactionTemplate signalTransaction;

    public CustomerWorkflowStepRunner(DomainEventProducer domainEventProducer,
