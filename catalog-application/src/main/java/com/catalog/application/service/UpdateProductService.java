...
public class UpdateProductService implements UpdateProductUseCase {
    ...
    private static final Logger log = Loggers.getLogger(UpdateProductService.class);
    ...
    private ProductVariant createVariant(String productName, UpdateProductCommand.Variant overrideVariant, List<ProductVariation> variations) {
        ...
        String sku = hasText(overrideVariant.sku())
                ? overrideVariant.sku()
    ...
    private ProductVariant resolveStandaloneVariant(Product product, UpdateProductCommand command) {
        ...
        if (existingStandalone.isPresent()) {
            ...
            String sku = override != null && hasText(override.sku())
                    ? override.sku()
                    : existing.getSku();
            return new ProductVariant(
                    existing.getId(),
