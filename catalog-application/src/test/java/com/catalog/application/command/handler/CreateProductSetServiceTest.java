...
import com.catalog.application.service.CreateProductSetService;
...
class CreateProductSetServiceTest {
    ...
    @InjectMocks
    private CreateProductSetService service;
    ...
    void handle_withVariantTypesMaterializesMatchingMatrixVariants() {
        ...
        CreateProductSetResult result = service.execute(command);
