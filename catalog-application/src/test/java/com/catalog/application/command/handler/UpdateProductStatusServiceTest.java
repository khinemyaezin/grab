...
import com.catalog.application.service.UpdateProductStatusService;
...
class UpdateProductStatusServiceTest {
    ...
    private UpdateProductStatusService service;
    ...
    @BeforeEach
    void setUp() {
        service = new UpdateProductStatusService(productRepository, categoryRepository);
    }
    ...
    void handle_draftToActiveWithActiveVariants() {
        ...
        UpdateProductStatusResult result = service.execute(command);
