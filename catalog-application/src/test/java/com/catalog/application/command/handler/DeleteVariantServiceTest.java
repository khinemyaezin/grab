...
import com.catalog.application.service.DeleteVariantService;
...
class DeleteVariantServiceTest {
    ...
    private DeleteVariantService service;
    ...
    @BeforeEach
    void setUp() {
        service = new DeleteVariantService(productRepository);
    }
    ...
    void handle_softDeletesActiveVariant() {
        ...
        DeleteVariantResult result = service.execute(command);
