...
import com.catalog.application.service.SaveCategoryService;
...
class SaveCategoryServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new SaveCategoryService(categoryRepository, idGenerator);
    }
    ...
    void handle_rootCategoryCreatesDefaultRootPolicy() {
        ...
        SaveCategoryResult result = service.execute(new SaveCategoryCommand(
                "Electronics",
                null,
                false,
                true,
    ...
    void handle_missingParentThrows() {
        ...
        assertThatThrownBy(() -> service.execute(new SaveCategoryCommand(
                "Cameras",
                parentId,
                true,
                true,
