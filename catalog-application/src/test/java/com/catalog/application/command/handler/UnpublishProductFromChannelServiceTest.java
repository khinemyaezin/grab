...
import com.catalog.application.service.UnpublishProductFromChannelService;
...
class UnpublishProductFromChannelServiceTest {
    ...
    private UnpublishProductFromChannelService service;

    @BeforeEach
    void setUp() {
        service = new UnpublishProductFromChannelService(productRepository, productPublicationRepository);
    }
    ...
    void handle_whenMissingRow_isNoOp() {
        ...
        UnpublishProductFromChannelResult result = service.execute(command());
