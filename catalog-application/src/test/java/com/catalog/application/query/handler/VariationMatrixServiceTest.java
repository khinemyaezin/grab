...
import com.catalog.application.service.VariationMatrixService;
...
class VariationMatrixServiceTest {
    ...
    public void handle_deleteVariantManually_returnCombination() {
        ...
        VariationMatrixResult result = service.execute(query);
