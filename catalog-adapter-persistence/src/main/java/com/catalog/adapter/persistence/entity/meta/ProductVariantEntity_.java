...
public class ProductVariantEntity_ {
    ...
    public static volatile SingularAttribute<ProductVariantEntity, String> thumbnailMediaUuid;
    ...
    public static final String THUMBNAIL_MEDIA_UUID = "thumbnailMediaUuid";
