...
@AllArgsConstructor
public class CategoryHierarchyAdapter implements CategoryHierarchyPort {

    private static final Logger log = Loggers.getLogger(CategoryHierarchyAdapter.class);
