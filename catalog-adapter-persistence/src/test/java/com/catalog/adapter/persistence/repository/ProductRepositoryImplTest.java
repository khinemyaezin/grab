...
import com.catalog.adapter.persistence.exception.CatalogInfraException;
import com.grab.framework.event.DomainEventProducer;
import com.catalog.adapter.persistence.mapper.ProductJpaAssembler;
import com.catalog.adapter.persistence.adapter.ProductRepositoryAdapter;
...
class ProductRepositoryImplTest {
    ...
    void setUp() {
        ...
        repository = new ProductRepositoryAdapter(productJpaAssembler, productJpaRepo, domainEventProducer, new CatalogPersistenceExecutor());
    }
