...
import com.catalog.adapter.persistence.adapter.CategoryHierarchyAdapter;
...
class CategoryHierarchyJpaRepositoryTest {
    ...
    private CategoryHierarchyAdapter repository;

    @BeforeEach
    void setUp() {
        categoryNodeRepository = mock(CategoryNodeRepository.class);
        idGenerator = mock(IdGenerator.class);
        repository = new CategoryHierarchyAdapter(
