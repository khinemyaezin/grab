...
import com.catalog.adapter.persistence.adapter.VariantTypeRepositoryAdapter;
...
class VariantTypeRepositoryImplTest {
    ...
    private VariantTypeRepositoryAdapter repository;
    ...
    void setUp() {
        ...
        repository = new VariantTypeRepositoryAdapter(
    ...
    void save_whenConstraintViolationOccurs_shouldThrowTypedInfrastructureConflict() {
        ...
        var exception = assertThrows(com.catalog.adapter.persistence.exception.CatalogInfraException.class, () -> repository.save(variantType));
