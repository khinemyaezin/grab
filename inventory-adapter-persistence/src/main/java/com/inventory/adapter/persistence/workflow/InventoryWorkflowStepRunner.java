package com.inventory.adapter.persistence.workflow;
...
public class InventoryWorkflowStepRunner extends WorkflowStepRunner {
    private final TransactionTemplate stepTransaction;
    private final TransactionTemplate signalTransaction;

    public InventoryWorkflowStepRunner(DomainEventProducer domainEventProducer,
