package com.inventory.adapter.persistence.repository.jpa.config;

import com.inventory.adapter.persistence.repository.jpa.*;
...
public class RepositoryTestConfig extends PostgreSqlTestContainer {
    ...
    @EnableAutoConfiguration
    @EntityScan(basePackages = "com.inventory.adapter.persistence.entity")
