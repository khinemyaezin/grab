...
class InventoryQueryAdapterTest {
    ...
    private ChannelFulfillmentRouteJpaRepository channelFulfillmentRouteJpaRepository;
    private PersistenceExecutor executor;
    private InventoryQueryAdapter repository;
    ...
    void setUp() {
        ...
        channelFulfillmentRouteJpaRepository = mock(ChannelFulfillmentRouteJpaRepository.class);
        executor = mock(PersistenceExecutor.class);
        repository = new InventoryQueryAdapter(
                searchSpecification,
