...
class ZoneRepositoryAdapterTest {
    ...
    private ZoneRepositoryAdapter repository;
    ...
    void setUp() {
        ...
        repository = new ZoneRepositoryAdapter(jpaRepository, mapper, domainEventProducer, executor);
