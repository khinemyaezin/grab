...
public class RoleJpaRepositoryTest extends RepositoryTestConfig {
    ...
    void findTop5ByNameStartingWithIgnoreCase_returnsMatchingRoles() {
        List<RoleEntity> result = roleJpaRepository.findTop5ByNameStartingWithIgnoreCase("admin");
    ...
    void findTop5ByNameStartingWithIgnoreCase_returnsEmpty_whenNoMatch() {
        List<RoleEntity> result = roleJpaRepository.findTop5ByNameStartingWithIgnoreCase("xyz");
    ...
    void findTop5ByNameStartingWithIgnoreCase_matchesMultiple() {
        List<RoleEntity> result = roleJpaRepository.findTop5ByNameStartingWithIgnoreCase("v");

        assertThat(result).hasSize(1);
        assertThat(result.getFirst().getName()).isEqualTo("Viewer");
        
        List<RoleEntity> result2 = roleJpaRepository.findTop5ByNameStartingWithIgnoreCase("s");
