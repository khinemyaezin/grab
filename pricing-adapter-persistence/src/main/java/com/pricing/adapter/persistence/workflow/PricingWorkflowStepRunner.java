package com.pricing.adapter.persistence.workflow;
...
public class PricingWorkflowStepRunner extends WorkflowStepRunner {
    private final TransactionTemplate stepTransaction;
    private final TransactionTemplate signalTransaction;

    public PricingWorkflowStepRunner(DomainEventProducer domainEventProducer,
