...
store/.../workflows/
  ...
  WorkflowProcess beans          — e.g. CreateSellableProductDefinition, UpdateProductVariantDefinition
  rest/                          — start / get only
...
- Update-sellable-product and update-product-variant now run on `WorkflowProcess` definitions + `EventDrivenWorkflowEngine`.
